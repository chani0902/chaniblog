...
<div class="container">
	...
	<div class="page-header">
  		<h1>댓글 삭제 <small>Delete your Comment</small></h1>
	</div>

	
	<form action="r01_deleteOK.do" method="post">
	...
	<h4><b>댓글 번호</b> : ${vo.reply01_num}</h4>
	<br>
	<h4><b>댓글 내용</b> : ${vo.reply01_content}</h4>
	<br>
	<h4>정말 삭제하시겠습니까?<br><br><small>삭제된 댓글은 복구할 수 없습니다</small></h4>
	<br>
	<br>
	<button type="submit" class="btn btn-danger">삭제</button>
	<a href="/myproject/b01_selectOne.do?board01_num=${vo.board01_num}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchKey=${scri.searchKey}&searchWord=${scri.searchWord}" class="btn btn-primary">취소</a>
	</form>
</div>	
</body>
</html>